<script>
	...
	$: phoneColor = phoneOnMouseEnter ? '#d63030' : '#FFF';
	$: mobileColor = mobileOnMouseEnter ? '#d63030' : '#FFF';
	$: jedColor = jedOnMouseEnter ? '#d63030' : '#FFF';
...
<nav class={`w-full bg-surface-500 text-white ${`h-auto sm:h-12`}`}>
	<div class="container mx-auto">
		<div class={`sm:flex items-center justify-between ${`h-auto sm:h-12`}`}>
			...
			<!-- right side content -->
			<div class="flex justify-end sm:justify-normal py-3">
				<ul class="flex">
					<!-- YouTube -->
					<li
