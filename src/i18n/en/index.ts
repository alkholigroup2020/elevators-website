...
const en: BaseTranslation = {
	...
	welcomeSection: {
		heading: 'Welcome To',
		headingSpan: 'BuildingTec',
		firstTitle: 'Easy Setup',
		firstParagraph: 'For your company or at home, and with or without a shaft, we can do both.',
		secondTitle: 'European Quality',
		secondParagraph:
	...
	career: {
		...
		textAreaPlaceholder: 'Enter your cover letter here ...',
		textAreaError1: 'Message is too short!',
		textAreaError2: 'Message is too long! Maximum 2000 characters.',
		position: 'Position Applied For :',
		nationality: 'Nationality :',
		nationPlaceholder: 'Search for your nationality ...',
		dateOfBirth: 'Date Of Birth :',
		degreeLevel: 'Degree Level :',
		careerLevel: 'Career Level :',
		address: 'Residency City :',
		addressPlaceholder: 'Enter your residency city ...',
		addressError: 'City length should be more that 2 characters!',
		addressLengthError: 'City name is too long! Maximum 30 characters.',
		addressNumericError: 'No numbers are allowed!',
		employeeCV: 'Attach CV:',
		employeeCvMSG: 'Upload Your Resume ...',
		employeeCvSizeError: 'File is too large. Please upload a file that is less than 10MB.',
		employeeCvTypeError: 'Invalid file type. Please upload a Word or a PDF document.',
